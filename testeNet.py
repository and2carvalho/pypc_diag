...
# script adaptado de https://github.com/sivel/speedtest-cli/blob/master/speedtest.py
# obs. o script nessecita de argumento para rodar o main, por isso é preciso colocar uma [] dentro da variavel arg = data
# na def shell para rodar com arg default. Necessário tirar o loop(if name = main) de dentro da def main
...
# criado a variavel resultado_testeNet e definida como global para implementar as informações no dic json
    global DEBUG
    global resultado_testeNet
    ...
    print('Retornando configuração da speedtest.net...')
    try:
        speedtest = Speedtest(
        ...
        print('Não foi possível retornar a configuração da speedtest')
    ...
    if args.list:
        try:
            ...
            print('Não foi possível retornar a lista de server speedtest')
            raise SpeedtestCLIError(get_exception())
    ...
    print('Testando do cliente %(isp)s (%(ip)s)...' % speedtest.config['client'])

    if not args.mini:
        print('Retornando lista de servidores da speedtest.net...')
        try:
        ...
        if args.server and len(args.server) == 1:
            print('Retornanado informação para o servidor selecionado...')
        else:
            print('Selecionando melhor servidor com base no ping...')
    ...
    resultado_testeNet = results.dict()
    ...
    if args.share and not machine_format:
        print('Share results: %s' % results.share())  
